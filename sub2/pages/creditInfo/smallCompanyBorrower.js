        ...
        wx.request({
            ...
            success(res) {
                if (res.data.head.H_STATUS === "1") {
                    ...
                    that.setData({
                        companyInfo: jsonData.ENT_INFO[0],
            ...
            if (JSON.stringify(formData) == JSON.stringify(params)) {
                ...
                wx.showModal({
                    ...
                    success(res) {
                        ...
                        if (i > 0) {
                            $Toast({
                                content: "统一社会信用代码、工商注册号、组织机构代不为空",
                                type: "warning",
                                duration: 2,
                            });
                    ...
                    wx.showToast({
                        ...
                        success: res => {
                            setTimeout(function() {
                                ...
                                wx.redirectTo({
                                    url: "../creditInfo/smallCompanyAuth?business_type=" + that.data.business_type + "&page=1&business_id=" + that.data.business_id + scene + '&companyInfo='+ JSON.stringify(that.data.companyInfo),
                                });
                            }, 1000);
                        },
                    });
