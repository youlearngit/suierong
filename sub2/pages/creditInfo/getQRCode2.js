...
Page({
    ...
    onLoad: function(e) {
        that = this;
        console.log(e,'页面信息');
        this.setData({information:e,type:e.type});
        if(e.type == '1'){ //个人
          if(e.business_type == 3){
            ...
            if(e.business_type == 1){
              this.setData({yewuType : '借款企业'});
            }else if(e.business_type == 2){
                this.setData({yewuType : '担保企业'});
            }else if(e.business_type == 3){
              this.setData({yewuType : '关联企业'});
            }
        }else if(e.type == '3'){ //个人对公
            if(e.business_type == 1){
              this.setData({yewuType : '经营实体'});
            }else if(e.business_type == 2){
                this.setData({yewuType : '担保企业'});
            }else if(e.business_type == 3){
              this.setData({yewuType : '关联企业'});
...
// 二维码
    ...
    bindGetUserInfo(e) {
        ...
        console.log(that.data.qrcodeUrl,'二维码');
        wx.showLoading({
            // title: '图片生成中',
            title: '图片保存中...',
            mask: true,
...
if(Object.keys(that.data.information).length == 0){
    wx.hideLoading();
     wx.showToast({
            title: "页面信息获取失败",
            icon: "none",
                            ...
                            success(res) {
                                ...
                                if(that.data.type == '1'){
                                    if(that.data.information.business_type == 3){//对公授信
                                      ...
                                      context.fillText("SourceHanSansSC-Medium")
                                      ...
                                      context.setFillStyle('#171A55');context.fillRect(22, 990 + y, 500, 0.25)  //分割线
                                      //授权主体类型
                                    ...
                                    context.setFillStyle("#636482");context.setFontSize(28) 
                                    context.fillText(business,22,1012);//that.data.information.business_name(0,15)
                                    context.fillText(business1,22,1042);//that.data.information.business_name(15)

                                    context.setFillStyle('#171A55');context.fillRect(22, 1030 + y, 500, 0.5)  //分割线
                                    //授权人类型
                                    context.drawImage(sqlx, 22, 1050 + y, 38, 38)
                                    context.setFillStyle("#636482");context.setFontSize(28)
                                    context.fillText(that.data.information.auth_type,82,1080 + y); //that.data.information.auth_type
                                    // //实体经营名称
                                    // context.drawImage(stmc, 22, 1050, 36, 36)
                                    // context.setFillStyle("#636482");context.setFontSize(28) 
                                    ...
                                    //授权人姓名
                                    context.drawImage(sqrxm, 22, 1105 + y, 38, 38)
                                    context.setFillStyle("#636482");context.setFontSize(28) 
                                    context.fillText(that.data.information.authName,82,1135 + y); //that.data.information.authName
                                    }
                                }else if(that.data.type == '2'){
                                    context.setFontSize(32) //文字字体
                                    context.setFillStyle("#4570DA")
                                    context.fillText("SourceHanSansSC-Medium")
                                    context.fillText(that.data.yewuType,585,910);//业务类型
                                    //借款企业
                                    context.setFillStyle("black");context.setFontSize(30)
                                    context.fillText('借款企业:'+jkqy,22,972); //that.data.information.business_name(0,13)
                                    context.fillText(jkqy1,22,972 + y); //that.data.information.business_name.slice(13)
                                    context.setFillStyle('#171A55');context.fillRect(22, 990 + y, 500, 0.25)  //分割线
                                    //授权主体类型
                                    // context.drawImage(sqlx, 22, 1000 + y, 38, 38)
                                    context.setFillStyle("#636482");context.setFontSize(28)
                                    context.fillText('授权企业:'+that.data.information.auth_enter_name,22,1030 + y); 
                                    //授权人姓名
                                    context.drawImage(sqrxm, 22, 1050 + y, 38, 38)
                                    context.setFillStyle("#636482");context.setFontSize(28) 
                                    context.fillText('授权人:'+that.data.information.authName,82,1080 + y); //that.data.information.authName
                                }else if (that.data.type == '3'){
                                    context.setFontSize(32) //文字字体
                                    context.setFillStyle("#4570DA")
                                    context.fillText("Bitstream Vera Serif Bold")
                                    context.fillText(that.data.yewuType,565,910);  //业务类型
                                    //借款人姓名
                                    context.setFillStyle("black");context.setFontSize(38)
                                    context.fillText('借款人:'+that.data.information.borrwo_name,22,972);
                                    //经营实体
                                    context.setFillStyle("#636482");context.setFontSize(28)
                                    context.fillText('经营实体:'+ (that.data.information.business_name != ''?that.data.information.business_name:'无'),22,1022);
                                    context.setFillStyle('#636482');context.fillRect(22, 1035 + y, 500, 0.25)  //分割线
                                    //授权公司
                                    context.drawImage(sqlx, 22, 1050 + y, 38, 38)
                                    context.setFillStyle("#636482");context.setFontSize(28)
                                    context.fillText('授权公司:'+that.data.information.auth_enter_name,82,1080 + y); 
                                    //授权人姓名
                                    context.drawImage(sqrxm, 22, 1105 + y, 38, 38)
                                    context.setFillStyle("#636482");context.setFontSize(28) 
                                    context.fillText('法人:'+that.data.information.authName,82,1135 + y); //that.data.information.authName
                                }
                                ...
                                // 二维码
                                context.drawImage(img2, 547, 970, 170, 170)  //erweima 
                                // context.drawImage('wxfile://tmp_fe0266891f6417437441db17a3b54ce9', 547, 970, 170, 170)  //erweima 
    ...
    drawImage(context, retry, unit) {
        ...
        context.draw(false, function() {
            ...
            wx.canvasToTempFilePath({
                ...
                quality: 1,
                success: a => {
                    console.log(a.tempFilePath,'图片地址');
                    that.setData({
