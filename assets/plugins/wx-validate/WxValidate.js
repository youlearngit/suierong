...
class WxValidate {
    ...
    __initMethods() {
        ...
        that.methods = {
          ...
          /**
           * 验证统一社会信用代码 /[^_IOZSVa-z\W]{2}\d{6}[^_IOZSVa-z\W]{10}$/g
          ...
          orgID(value) {
             ...
             */
            tel(value) {
                return that.optional(value) || /^1[0123456789]\d{9}$/.test(value)
            },
            /**
             * 验证URL格式
             */
          ...
          /**
           * 验证中文名/[^\x00-\xff]/  /^[\u4E00-\u9FA5]{1,8}$/
           * 
           * 
           */
          name(value) {
            return that.optional(value) || /^[\u4E00-\u9FA5]{1,8}$/.test(value)
          },
          /**
           * 验证企业名称/[^\x00-\xff]/  /^[\u4E00-\u9FA5]{1,8}$/
           * 
           * 
           */
          orgName(value) {
            return that.optional(value) || /^[\u4E00-\u9FA5-（）()]{1,50}$/.test(value)
          },
