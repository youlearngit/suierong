...
Page({
  ...
  generateCardPoster() {
    ...
    let promise2 = new Promise(function (resolve, reject) {
      if (that.data.qrcodeUrl != '') {
        ...
        api.generateMiniCode('sub1/pages/xsd/index', that.data.empNo).then((res) => {
          if (res) {
            img2 = res;
            that.setData({
              qrcodeUrl: img2,
  ...
  generateCardPoster4() {
    ...
    let promise3 = api.generateMiniCode('sub1/pages/xsd/index', that.data.empNo).then((res) => {
      if (res) {
        img3 = res;
        return res;
      } else {
  ...
  generateCardPosterActivity() {
    ...
    let img3 = '';
    let promise1 = new Promise(function (resolve, reject) {
      let src = app.globalData.CDNURL + '/static/wechat/img/sui/shareShareRab2023.jpg';
      wx.getImageInfo({
        src: src,
        success: function (res) {
          img1 = res.path;
  ...
  generateCardPoster9() {
    ...
    let promise2 = api.generateMiniCode('sub1/pages/xsd/index', that.data.empNo).then((res) => {
      if (res) {
        img2 = res;
        return res;
      } else {
