...
Page({
  ...
  data: {
    ...
    avatar: '', //授权头像
    wechat: "", //本详情页二维码
    bg: "/static/wechat/img/temp/fhts/sz.jpg", //图片背景图
  ...
  onShareAppMessage: function() {
    ...
    var path = 'sub1/pages/sz/index' +"?open_id=" + share_id + "&share_date=" + util.formatTime(new Date())
    
    return {
      path: path,
      imageUrl: this.data.preffixUrl + "/static/wechat/img/temp/fhts/sz.jpg"
    }
  },
  indexpage: function() {
    wx.switchTab({
  ...
  showCreat: function(e) {
    ...
    if (that.data.submit) {
      ...
      //请求接口
      api.generateMiniCode("sub1/pages/sz/index").then(res=>{
          console.log(res);
        that.setData({
              ...
              if (err === 'unSelectIdcard') {
                wx.showModal({
                  ...
                  success: function (res) {
                    ...
                    wx.navigateTo({
                      url: '/sub1/pages/auth/index?type=2&url=/sub1/pages/sz/query',
                    });
                  },
                });
              }
