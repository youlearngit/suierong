...
Page({
    ...
    data: {
        ...
        avatar: "", //授权头像
        wechat: "", //本详情页二维码
        bg: "/static/wechat/img/xnd/share_xnd.png", //图片背景图
    ...
    */
            ...
            timer: setInterval(function () {
                ...
                if (copyRightItems > rightItems) {
                    ...
                    cxt_arc.arc(
                        ...
                        _w - 3,
                        -Math.PI * 1.1,
                        2 * Math.PI * (copyRightItems / totalItems) - Math.PI,
                        false
                    );
                    cxt_arc.stroke(); //对当前路径进行描边
                    cxt_arc.draw();
    ...
    showCreat: function (e) {
        ...
        if (that.data.submit) {
            ...
            //请求接口
            api.generateMiniCode("sub1/pages/xnd/index").then(res=>{
                that.setData({
