...
Page({
  ...
  generateCardPoster() {
    ...
    let promise2 = new Promise(function (resolve, reject) {
      if (that.data.qrcodeUrl != '') {
        ...
        api.generateMiniCode('sub1/pages/warehousing/index', that.data.empNo + 'a' + that.data.productCode).then((res) => {
          if (res) {
            img2 = res;
            that.setData({
              qrcodeUrl: img2,
  ...
  generateCardPoster4() {
    ...
    let promise3 = api
      .generateMiniCode('sub1/pages/warehousing/index', that.data.empNo + 'a' + that.data.productCode)
      .then((res) => {
        if (res) {
          img3 = res;
          return res;
