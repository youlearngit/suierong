...
Page({
  ...
  data: {
    ...
    avatar: '', //授权头像
    wechat: "", //本详情页二维码
    bg: "/static/wechat/img/temp/share_kyd_bg2.jpg", //图片背景图
  ...
  onShareAppMessage: function() {
    ...
    var title = '快易贷';
    var path = 'pages/kyd/index?open_id=' + "&share_date=" + util.formatTime(new Date());
  ...
  waiting() {
     wx.navigateTo({
       url: '/sub3/pages/common/apli?applyResult=kyd'
            })
    // wx.showToast({
    //   title: '敬请期待！',
    //   icon: 'none',
  ...
  showCreat: function(e) {
    ...
    if (that.data.submit) {
      ...
      //请求接口
      api.generateMiniCode("pages/kyd/index").then(res=>{
        that.setData({
