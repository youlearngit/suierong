...
Page({
  ...
  data: {
    ...
    avatar: '', //授权头像
    wechat: "", //本详情页二维码
    bg: "/static/wechat/img/temp/share_rencai_bg2.jpg", //图片背景图
  ...
  onShareAppMessage: function () {
    ...
    var path = 'pages/rencai/index' + "?open_id=" + share_id + "&share_date=" + util.formatTime(new Date());
    return {
      path: path,
  ...
  showCreat: function(e) {
    ...
    if (that.data.submit) {
      ...
      api.generateMiniCode("pages/rencai/index").then(res=>{
        that.setData({
