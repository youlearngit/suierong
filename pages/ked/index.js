...
Page({
	...
	data: {
		...
		avatar: "", //授权头像
		wechat: "", //本详情页二维码
		bg: "/static/wechat/img/temp/share_ked_bg2.jpg", //图片背景图
	...
	onShareAppMessage: function () {
		...
		return {
			path: path,
			imageUrl: this.data.preffixUrl + "/static/wechat/img/temp/common/ked_big.jpg",
		};
	},
	prePage() {
		wx.navigateBack();
	...
	showCreat: function (e) {
		...
		if (that.data.submit) {
            ...
            //请求接口
            api.generateMiniCode("pages/ked/index").then(res=>{
                that.setData({
                  ...
                  if (err === 'unSelectIdcard') {
                    wx.showModal({
                      ...
                      success: function (res) {
                        ...
                        wx.redirectTo({
                            url: "/sub1/pages/auth/index?type=2&url=/pages/ked/apli",
                        });
                      },
                    });
                  }
