...
Page({
  ...
  data: {
    ...
    avatar: '', //授权头像
    wechat: "", //本详情页二维码
    bg: "/static/wechat/img/sui/sukeShare@2x.png", //图片背景图
  ...
  onShareAppMessage: function () {
    ...
    var path = 'pages/suke/index' + "?open_id=" + share_id + "&share_date=" + util.formatTime(new Date());
    return {
      path: path,
  ...
  showCreat: function(e) {
    ...
    if (that.data.submit) {
      ...
      api.generateMiniCode("pages/suke/index").then(res=>{
        that.setData({
