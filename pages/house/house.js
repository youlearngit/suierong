...
Page({
  ...
  onLoad: function (options) {
    myPerformance.reportBegin(2021, 'house_house');
    if (options.type) {
      this.setData({
        type: options.type,
      });
    ...
    myPerformance.reportEnd(2021, 'house_house');
    var that = this;
    //查看用户是否上传信息
    that.apli();
    //查询用户是否有查询记录
    that.getHistroySeacch();
    // 实例化地图API核心类
  ...
  //     var that = this;
  //     that.setData({
  //       'house.buildname': e.detail.value,
  //     });
  //   },
  //   unitInput(e) {
  //     var that = this;
  //     that.setData({
  //       'house.danyuanname': e.detail.value,
  //     });
  //   },
  //   roomInput(e) {
  //     var that = this;
  //     that.setData({
  //       'house.house': e.detail.value,
  //     });
  //   },
  ...
  submitForm(e) {
    ...
    if (params.squre == '' || params.squre > 9999) {
      ...
      if (that.data.submit) {
        ...
        // wx.request({
        //   url: app.globalData.URL + 'ed0173',
        //   data: {
        //     cityId: that.data.house.cityID.substring(0, 4) + '00', //城市国际吗
        //     districtName: '', //区国际码
        //     estateName: that.data.house.housekey, //物业名称
        //     buildingNo: that.data.house.buildname, //栋号，
        //     houseUnitName: that.data.house.danyuanname, //单元号
        //     roomName: that.data.house.house, //房号
        //     gfa: that.data.area, //面积
        //     houseType: '', //房屋类型 默认住宅
        //     originalAmo: '', //物业登记价格
        //     buyYear: '', //购买年限
        //     appPurpose: '', //评估目的
        ...
        //         that.data.house.house = '';
        //       }
        //       var address1 = res.data.data.estateNameRes;
        //       let data = JSON.stringify({
        //         id_id: 'id',
        //         string_open_id: wx.getStorageSync('openid'),
        //         string_evaluateCode: res.data.data.busId, //编号
        //         string_saleprice: new Number(res.data.data.appSum).toString(), //估价金额
        //         string_unitprice: res.data.data.unitPrice, //单价
        //         string_alias: res.data.data.estateNameRes, //住宅名称
        //         string_communityname: that.data.house.housekey, //关键字
        //         string_buildname: that.data.house.buildname, //楼栋
        //         string_danyuanname: that.data.house.danyuanname, //单元
        //         string_housename: that.data.house.house, //房号
        //         string_area: res.data.data.gFA, //面积
        //         string_address: res.data.data.estateNameRes,
        //         string_city_id: that.data.house.cityID, //城市编码
        //       });
        ...
        //                 });
        //               } else if (that.data.type == 'sui') {
        //                 //console.log("sui", that.data.type);
