...
Page({
  ...
  data: {
    ...
    avatar: '', //授权头像
    wechat: "", //本详情页二维码
    bg: "/static/wechat/img/sui/xiaoweiShare@2x.png", //图片背景图
  ...
  onShareAppMessage: function () {
    ...
    var path = 'pages/xiaowei/index' + "?open_id=" + share_id + "&share_date=" + util.formatTime(new Date());
    return {
      path: path,
      imageUrl: app.globalData.CDNURL + '/static/wechat/img/sui/sui-1068.png'
      // imageUrl: this.data.preffixUrl +  "/static/wechat/img/temp/share_rcd_f.jpg"
    }
  },
  indexpage: function() {
    wx.switchTab({
  ...
  showCreat: function(e) {
    ...
    if (that.data.submit) {
      ...
      api.generateMiniCode("pages/xiaowei/index").then(res=>{
        that.setData({
