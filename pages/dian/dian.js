...
Page({
	...
	data: {
		...
		avatar: "", //授权头像
		wechat: "", //本详情页二维码
		bg: "/static/wechat/img/temp/share_dian_bg2.jpg", //图片背景图
    ...
    */
	...
	onShareAppMessage: function () {
		...
		var path = "pages/dian/dian" + "?open_id=" + share_id + "&share_date=" + util.formatTime(new Date());
		return {
			path: path,
			imageUrl: this.data.preffixUrl + "/static/wechat/img/temp/share_dian_f.jpg",
		};
	},
	indexpage: function () {
		wx.switchTab({
	...
	showCreat: function (e) {
		...
		if (that.data.submit) {
            ...
            api.generateMiniCode("pages/dian/dian").then(res=>{
                that.setData({
                    ...
                    if (err === "unSelectIdcard") {
                        wx.showModal({
                            ...
                            success: function (res) {
                                ...
                                wx.navigateTo({
                                    url: "/sub1/pages/auth/index?type=2&url=/pages/dian/apli",
                                });
                            },
                        });
                    }
