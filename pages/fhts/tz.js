...
Page({
  ...
  data: {
    ...
    avatar: '', //授权头像
    wechat: "", //本详情页二维码
    bg: "/static/wechat/img/temp/fhts/tz.jpg", //图片背景图
  ...
  onShareAppMessage: function () {
    ...
    var path = 'pages/fhts/tz' + "?open_id=" + share_id + "&share_date=" + util.formatTime(new Date());
    return {
      path: path,
      imageUrl: this.data.preffixUrl + "/static/wechat/img/temp/fhts/tz.jpg"
    }
  },
  indexpage: function () {
    wx.switchTab({
  ...
  showCreat: function (e) {
    ...
    if (that.data.submit) {
      ...
      api.generateMiniCode("pages/fhts/tz").then(res=>{
        that.setData({
