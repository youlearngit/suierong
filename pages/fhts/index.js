...
Page({
  ...
  data: {
    ...
    avatar: '', //授权头像
    wechat: "", //本详情页二维码
    bg: "/static/wechat/img/temp/fhts/nj.jpg", //图片背景图
  ...
  onShareAppMessage: function () {
    ...
    var path = "pages/fhts/nj" + "?open_id=" + share_id + "&share_date=" + util.formatTime(new Date());
    return {
      path: path,
      imageUrl: this.data.preffixUrl + "/static/wechat/img/temp/fhts/nj.jpg"
    }
  },
  indexpage: function () {
    wx.switchTab({
  ...
  showCreat: function (e) {
    ...
    if (that.data.submit) {
      ...
      api.generateMiniCode("pages/fhts/nj").then(res=>{
        that.setData({
  ...
  createNewImg: function () {
    ...
    context.drawImage(path, 0, 0, 750, 861); //背景绘制
    ...
    context.fillText("长按立即查看", 565, 1156); //提示绘制
    //绘制头像
