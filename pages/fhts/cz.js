...
Page({
	...
	data: {
		...
		avatar: "", //授权头像
		wechat: "", //本详情页二维码
		bg: "/static/wechat/img/temp/fhts/cz.jpg", //图片背景图
	...
	onShareAppMessage: function () {
		...
		var path = "pages/fhts/cz" + "?open_id=" + share_id + "&share_date=" + util.formatTime(new Date());
		return {
			path: path,
			imageUrl: this.data.preffixUrl + "/static/wechat/img/temp/fhts/cz.jpg",
		};
	},
	indexpage: function () {
		wx.switchTab({
	...
	showCreat: function (e) {
		...
		if (that.data.submit) {
            ...
            //请求接口
              ...
              api.generateMiniCode("pages/fhts/cz").then(res=>{
                that.setData({
