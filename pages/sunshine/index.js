...
Page({
    ...
    data: {
        ...
        avatar: '', //授权头像
        wechat: "", //本详情页二维码
        bg: "/static/wechat/img/temp/sunshine_bg2.png", //图片背景图
    ...
    onShareAppMessage: function () {
      ...
      var path = "pages/sunshine/index" + "?open_id=" + share_id + "&share_date=" + util.formatTime(new Date());
        return {
            path: path,
            imageUrl: this.data.preffixUrl + this.data.bg
        }
    },
    indexpage: function () {
        wx.switchTab({
    ...
    showCreat: function (e) {
        ...
        if (that.data.submit) {
            ...
            //请求接口
            api.generateMiniCode("pages/sunshine/index").then(res=>{
                that.setData({
                  ...
                  if (err === 'unSelectIdcard') {
                    wx.showModal({
                      ...
                      success: function (res) {
                        ...
                        wx.navigateTo({
                            url: '/sub1/pages/info/identify?type=3&url=/pages/sunshine/index',
                        });
                      },
                    });
                  }
