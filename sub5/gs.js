                                                                    ...
                                                                    success(res) {
                                                                        ...
                                                                        wx.request({
                                                                            ...
                                                                            success(res) {
                                                                                ...
                                                                                //识别成功返回营业执照信息
                                                                                console.log('res.data.bodyE',res.data.body);
                                                                                res.data.body.batchID = batchID
                                                                                console.log('res.data.body.RE_COMPANY_NAME',res.data.body.RE_COMPANY_NAME);
                                                                                resolve(res.data.body, batchID);
                                                                            },
                                                                            fail(res) {
                                                                                wx.hideLoading({
                                                                                    success: (res) => {
