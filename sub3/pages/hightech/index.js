...
Page({
  ...
  data: {
    ...
    avatar: '', //授权头像
    wechat: "", //本详情页二维码
    bg: "/static/wechat/img/temp/share_hightech_bg2.jpg", //图片背景图
  ...
  onShareAppMessage: function () {
    ...
    var path = '/sub3/pages/hightech/index' + "?open_id=" + share_id
    return {
      path: path,
      imageUrl: this.data.preffixUrl + "/static/wechat/img/temp/hightech_bg.jpg"
    }
  },
  prePage() {
    wx.navigateBack();
  ...
  showCreat: function (e) {
    ...
    if (that.data.submit) {
      ...
      api.generateMiniCode("sub3/pages/hightech/index").then(res=>{
        that.setData({
