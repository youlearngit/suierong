...
Page({
  ...
  data: {
    ...
    canvasId: 'mycanvas',
    bg: "/static/wechat/img/rcd/cxjfdfx.png", //图片背景图
    channel: '11',
    phone: '11',
    talent_level: '11',
    idcard: '11',
  ...
  onLoad(options) {
    ...
    if (options.talents == 0) {
      bgUrl = "/static/wechat/img/rcd/cxjfdfx.png"
  ...
  showCreat: function (e) {
    ...
    if (that.data.submit) {
      ...
      api.generateMiniCode("sub3/pages/bbx/innovate/index").then(res => {
        console.log(res);
        that.setData({
  ...
  createNewImg: function () {
    ...
    context.fillText(nickname,30, 1096); //昵称绘制
    context.stroke();
    context.setFontSize(20);
    // context.setFontSize(36);
    context.fillText("长按立即申请", 545, 1096); //提示绘制
